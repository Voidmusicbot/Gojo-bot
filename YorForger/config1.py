# Create a new config1.py or rename this to config1.py file in same dir and import, then extend this class.
import json
import os
...
def get_user_list(config1, key):
    with open("{}/Senku/{}".format(os.getcwd(), config1), "r") as json_file:
...
class Config(object):
    ...
    CUSTOM_CMD = (
        "awoo" # Icurrently don't know abt this.
    )
